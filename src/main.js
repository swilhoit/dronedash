...
let gameState = {
    ...
    orderQueue: [],
    deliveryLocations: [],
    pickupRadius: 500,      // meters - EASY pickup range
    deliveryRadius: 500,    // meters - EASY delivery range
    maxDeliveryAltitude: 300, // meters above ground - can deliver from higher up
    orderInterval: null,
    gameTime: 0,
    streak: 0,
    bestStreak: 0
